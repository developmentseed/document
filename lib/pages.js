 ...
 * Expose new form.
 */
app.get('/new/*', document.forms.NewDocumentForm.load(), function(req, res) {
 ...
 */
app.post('/new/*', document.forms.NewDocumentForm.load(), function(req, res) {
 ...
 * Expose edit form.
 */
app.get('/edit/*', document.forms.EditDocumentForm.load(), function(req, res) {
    req.form.render(req, res);
});
 ...
 * Handle edit form.
 */
app.post('/edit/*', document.forms.EditDocumentForm.load(), function(req, res) {
    req.form.process(req, res);
});
 ...
 * Expose delete form.
 */
app.get('/delete/*', document.forms.DeleteDocumentForm.load(), function(req, res) {
    req.form.render(req, res);
});
 ...
 * Handle delete form.
 */
app.post('/delete/*', document.forms.DeleteDocumentForm.load(), function(req, res) {
    req.form.process(req, res);
});
