 ...
 * Expose new form.
 */
app.get('/new/*', forms.loadForm(document.forms.NewDocumentForm), function(req, res) {
 ...
 */
app.post('/new/*', forms.loadForm(document.forms.NewDocumentForm), function(req, res) {
 ...
 * Expose edit form.
 */
app.get('/edit/*', forms.loadForm(document.forms.EditDocumentForm), function(req, res) {
    req.form.render(req, res);
});
 ...
 * Handle edit form.
 */
app.post('/edit/*', forms.loadForm(document.forms.EditDocumentForm), function(req, res) {
    req.form.process(req, res);
});
 ...
 * Expose delete form.
 */
app.get('/delete/*', forms.loadForm(document.forms.DeleteDocumentForm), function(req, res) {
    req.form.render(req, res);
});
 ...
 * Handle delete form.
 */
app.post('/delete/*', forms.loadForm(document.forms.DeleteDocumentForm), function(req, res) {
    req.form.process(req, res);
});
