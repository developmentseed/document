...
var user = require('user'),
    ...
    settings = require('expresslane').app.set('settings')('document');
 ...
 */
Document.prototype.editForm = function() {
    var that = this;
    return {
        fields: function() {
 ...
 */
Document.prototype.deleteForm = function() {
    var that = this;
    return {
        fields: function() {
            var forms = require('forms');
...
// TODO Ideally, pages are a separate module from document but living in the
// same directory.
require('./pages');
