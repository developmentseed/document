...
NewDocumentForm.on('success', function(req, res) {
...
EditDocumentForm.prototype.render = function(req, res,next) {
    res.render(view('content'), {
        locals: {
          pageTitle: 'Edit ',
          title: 'Edit new ',
...
EditDocumentForm.on('success', function(req, res) {
...
DeleteDocumentForm.prototype.fields.cancel.__defineGetter__('value', function() {
...
DeleteDocumentForm.prototype.render = function(req, res,next) {
    res.render(view('content'), {
        locals: {
          pageTitle: 'Delete ' + this.document.data._id,
          title: 'Delete ' + this.document.data._id,
          content: this.toHTML()
        }
    });
}
